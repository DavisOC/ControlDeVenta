 ...
 * @author
 */
public class FormularioDelProducto extends JPanel {

    private final Producto producto;
    private final RegistrarProductoAccion registrarAccion;
    ...
    public FormularioDelProducto(RegistrarProductoAccion registrarAccion, Producto producto) {
